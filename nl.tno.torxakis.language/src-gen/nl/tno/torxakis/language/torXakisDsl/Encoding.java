 ...
 * </p>
 * <ul>
 *   <li>{@link nl.tno.torxakis.language.torXakisDsl.Encoding#getCommunication <em>Communication</em>}</li>
 *   <li>{@link nl.tno.torxakis.language.torXakisDsl.Encoding#getChannelOffer <em>Channel Offer</em>}</li>
 * </ul>
 *
 * @see nl.tno.torxakis.language.torXakisDsl.TorXakisDslPackage#getEncoding()
 * @model
 * @generated
 */
public interface Encoding extends ConnectionItem
{
  /**
   ...
   * @see nl.tno.torxakis.language.torXakisDsl.TorXakisDslPackage#getEncoding_Communication()
  ...
  /**
   * Sets the value of the '{@link nl.tno.torxakis.language.torXakisDsl.Encoding#getCommunication <em>Communication</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see nl.tno.torxakis.language.torXakisDsl.TorXakisDslPackage#getEncoding_ChannelOffer()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link nl.tno.torxakis.language.torXakisDsl.Encoding#getChannelOffer <em>Channel Offer</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
